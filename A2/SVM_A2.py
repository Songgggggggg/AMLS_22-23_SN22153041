...
def extract_features_labels():
    ...
    return landmark_features, smile_labels, wrong_img
...
parameters = [
    {
        'kernel': ['rbf'],
        'C': [1 * 10**i for i in range(-3, 8)],
        'gamma': [1 * 10**i for i in range(-3, 5)],
...
ax.xaxis.set_ticklabels(['Smiling', 'Not Smiling'])
ax.yaxis.set_ticklabels(['Smiling', 'Not Smiling'])
