...
def extract_features_labels_mouth(images_dir, celeba_dir, labels_filename):
    """
...
def data_preprocessing_A2(images_dir, celeba_dir, labels_filename):
	# Extract feature data
	feature, label, _ = extract_features_labels_mouth(images_dir, celeba_dir, labels_filename)
...
def train(X, y, test_X, test_Y):
    ...
    clf_rbf = SVC(C=10, gamma = 10, kernel='rbf')
    clf_linear = SVC(C=10, kernel = 'linear', max_iter=1000000)
