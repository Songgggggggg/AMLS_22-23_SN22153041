...
def extract_features_labels_face(cartoon_images_dir, cartoon_dir, labels_filename):
    """
    ...
    target_size = None
    labels_file = open(os.path.join(cartoon_dir, labels_filename), 'r')
...
def data_preprocessing_B1(cartoon_images_dir, cartoon_dir, labels_filename):
	# Extract feature data
	feature, label, _ = extract_features_labels_face(cartoon_images_dir, cartoon_dir, labels_filename)
